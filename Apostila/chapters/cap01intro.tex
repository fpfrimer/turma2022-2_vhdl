...
\begin{figure}[htbp]
    ...
    \label{fig:onda_and}
    \includegraphics[width=0.7\textwidth]{figures/onda_and.png}    
\end{figure}
...
\begin{enumerate}
    ...
    \item Na analogia da bancada modular, o que permanece fixo e o que muda quando um novo projeto é carregado?
