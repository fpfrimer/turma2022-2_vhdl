-- Este testbench VHDL é projetado para testar o funcionamento do multiplexador definido na entidade a007b_mux.
...
entity a007c_mux_tb is
end a007c_mux_tb;

architecture sim of a007c_mux_tb is
...
begin
    ...
    dut_mux: entity work.a007b_mux(rtl) port map(
